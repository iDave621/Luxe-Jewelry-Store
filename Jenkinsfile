                    ...
                    script {
                        timeout(time: 10, unit: 'MINUTES') {
                            ...
                            sh '''
                                ...
                                echo "║                                                                ║"
                                echo "║  🌐 Via URL (Run as Administrator):                            ║"
                                echo "║     .\\setup-ingress-url.ps1                                    ║"
                                echo "║     Then: http://luxe-jewelry.local                            ║"
                                echo "║                                                                ║"
                                echo "║  📋 Alternative Access (Quick Testing):                        ║"
                                ...
                                echo "║     kubectl get ingress -n luxe-jewelry                        ║"
                                echo "║                                                                ║"
                                echo "╚════════════════════════════════════════════════════════════════╝"
                                echo ""
                            '''
