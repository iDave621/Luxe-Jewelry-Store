                    ...
                    script {
                        timeout(time: 10, unit: 'MINUTES') {
                            ...
                            sh '''
                                ...
                                echo "║                                                                ║"
                                echo "║  1️⃣  Start the Ingress tunnel (keep it running):              ║"
                                echo "║     PowerShell> .\\start-ingress-tunnel.ps1                     ║"
                                echo "║                                                                ║"
                                echo "║  2️⃣  Access your app at:                                       ║"
                                echo "║     http://luxe-jewelry.local:XXXXX                            ║"
                                echo "║     (Port number shown when tunnel starts)                     ║"
                                echo "║                                                                ║"
                                echo "║  ℹ️  The tunnel must stay running for the URL to work          ║"
                                echo "║                                                                ║"
                                echo "║  🔍 Check Status:                                              ║"
